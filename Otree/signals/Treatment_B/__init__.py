...
class Player(BasePlayer):
    ...
    belief_input_raw = models.FloatField(default=50) # 0–100 (B1)
...
class Belief(Page):
    ...
    def error_message(player: Player, values):
        ...
        if not (0 <= v <= 100):
            return 'Enter how many red dots you saw (0–100).'
...
class Choice(Page):
    ...
    def before_next_page(player: Player, timeout_happened):
        ...
        record_main_round(player, app_label='Treatment_B')
