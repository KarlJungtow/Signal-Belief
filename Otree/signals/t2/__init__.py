...
def creating_session(subsession: Subsession):
    ...
    for p in subsession.get_players():
        if subsession.round_number == 1:
            ...
            p.participant.vars['t2_schedule'] = schedule
            p.participant.vars['t2_images'] = images

        r, x = p.participant.vars['t2_schedule'][subsession.round_number - 1]
        image_file = p.participant.vars['t2_images'][subsession.round_number - 1]
...
page_sequence = [IncomeInfo, Signal, Belief, Choice, SyncGate]
